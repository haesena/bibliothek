...
$app->get('/books/{id}/copy', Controller\BookController::class . ':copyBook')->setName('book-copy');

$app->get('/booksrep', Controller\BookController::class . ':repBooks')->setName('books-rep');
...
$app->get('/genre/{id}/copy', Controller\GenreController::class . ':copyGenre')->setName('genre-copy');